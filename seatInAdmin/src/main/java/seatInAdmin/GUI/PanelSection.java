...
public class PanelSection extends JPanel {
	...
	protected PanelSection(String name, String id) {
		...
		String[] a = { "Section A", "Section B", "Section C", "Section A", "Section B", "Section C", "Section A",
				"Section B", "C", "A", "B", "C", "Z", "Z", "Z" };

		String[] b = { "Resource A", "Resource B", "Resource C", "Resource A", "Resource B", "Resource C", "Resource A",
				"Resource B", "Resource C", "A", "B", "C", "Z", "Z", "Z" };
		...
		openResButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				frame.getContentPane()
						.add(new PanelResourceAdmin(resList.getSelectedValue(), resList.getSelectedValue()));
				frame.pack();
		...
		openSecButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				frame.getContentPane().removeAll();
				frame.getContentPane()
						.add(new PanelSectionAdmin(secList.getSelectedValue(), secList.getSelectedValue()));
				frame.pack();
				frame.getContentPane().validate();
