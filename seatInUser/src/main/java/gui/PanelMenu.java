...
public class PanelMenu extends JPanel {
	...
	protected PanelMenu() {
		...
		generateBody();
		generateSummary(summary, "Mario", "Rossi", "123456");
		generateButtonPanel();
		generateBackPanel();
		...
		ListSelectionListener asd = new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				if (!list.isSelectionEmpty()) {
					...
					new ToCourse(c, (String) courses.getValueAt(selectedRow, 0),
							(String) courses.getValueAt(selectedRow, 2), (String) courses.getValueAt(selectedRow, 1),
							(String) courses.getValueAt(selectedRow, 3));
				}
	...
	private void fillTable(DefaultTableModel model) {
		...
		model.addRow(new Object[] { "030986", "Astrologia", "20XX", "Scienze Stupide" });
	...
	private void generateSummary(JPanel summary, String name, String surname, String id) {
	...
	protected void generateButtonPanel() {
		profileButton.addActionListener(new ToProfileAction(this));
